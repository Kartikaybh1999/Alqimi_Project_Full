...
export class UserComponent implements OnInit, OnDestroy {
 ...
 private localtoken = localStorage.getItem('token');
...
// if(this.token!=this.user.tokenJwt){
...
// }
  ...
  public changeTitle(title: string): void {
   ...
   sendErrorNotification(ERROR: NotificationType, message: any) {
  ...
  public getUsers(showNotification: boolean): void {
    ...
    this.subscriptions.push(
      this.userService.getUsers(this.user.username).subscribe(
        (response: User[]) => {
  ...
  public onLogOut(user:User): void {
    ...
    this.subscriptions.push(
      this.userService.deleteUserToken(user.username).subscribe(
...
public onLogout2(user:User):void{
  this.authenticationService.logOut();   
  this.router.navigate(['/login']);
 this.sendNotification(NotificationType.SUCCESS, `You've been successfully logged out`);
}
